#!/bin/bash
​
corewar_orig="vm_champs/corewar_orig" ## путь к оригиналу
corewar_my="corewar" ## путь к своему корвару
​
folder="vm_champs/valid"
path="./$folder"
	...
	do
		...
		then
			...
			do
				##let num=7100+c*1
				num="${number[$c]}"
				my=$(./$corewar_my -d $num $path/$file1 $path/$file2)
